...
//
//const textwrite = `Hello Pratik This is a what we know about the avacado: ${textread}.\nCreating/Inserting javascript part ${Date.now()} `;
...
server.listen(8000, '127.0.0.1', () => {
    console.log('Listening to request port on 8000');
});